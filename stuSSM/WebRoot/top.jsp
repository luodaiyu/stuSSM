...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <li><a href="tab.html"  target="rightFrame"><img src="images/icon06.png" title="系统设置" /><h2>系统设置</h2></a></li>
     ...
     <p:parameter url="toUserList">   
      	<li><a href="toUserList" target="rightFrame"><img src="images/icon05.png" title="文件管理" /><h2>用户管理</h2></a></li>
     </p:parameter>
     <p:parameter url="toMenuListAction">
        <li><a href="toMenuListAction"  target="rightFrame"><img src="images/icon06.png" title="系统设置" /><h2>菜单管理</h2></a></li>
      </p:parameter>
    </ul>   
    --> 
    <div class="topright">    
