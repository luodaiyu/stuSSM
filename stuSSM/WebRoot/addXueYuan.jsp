...
<body>
    ...
    <ul class="forminfo">
    <li><label>学院名称：</label><input id="xName" name="xName" type="text" class="dfinput" /><i id="xName">学院名称不能为空</i></li>
...
<script>
	$(function(){
		...
		$(".btn").click(function(){
			if(checkxName()&&checkurl()){
				$.ajax({
					url:'doaddxueyuan.do',
					data:{xName:$("#xName").val(),url:$("#url").val()},
					type:'post',
